...
var expectedFailures = module.exports = {
	...
	// 'doubles: jumpWords(-1) + onceBegin > jumpWords(-1) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpWords(-1) + onceBegin > jumpWords(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpWords(-1) + loopBegin > jumpWords(-1) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpWords(-1) + loopBegin > jumpWords(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpWords(-1) + newWordFragment > jumpWords(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	
	// 'doubles: jumpWords(0) + onceBegin > jumpWords(0) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpWords(0) + onceBegin > jumpWords(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpWords(0) + loopBegin > jumpWords(0) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpWords(0) + loopBegin > jumpWords(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpWords(0) + newWordFragment > jumpWords(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]

	// 'doubles: jumpWords(11) + onceBegin > jumpWords(11) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpWords(11) + onceBegin > jumpWords(11) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpWords(11) + loopBegin > jumpWords(11) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpWords(11) + loopBegin > jumpWords(11) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpWords(11) + newWordFragment > jumpWords(11) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	
	// 'doubles: jumpWords(100) + onceBegin > jumpWords(100) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpWords(100) + onceBegin > jumpWords(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpWords(100) + loopBegin > jumpWords(100) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpWords(100) + loopBegin > jumpWords(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpWords(100) + newWordFragment > jumpWords(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	
	// 'doubles: jumpSentences(-1) + onceBegin > jumpSentences(-1) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpSentences(-1) + onceBegin > jumpSentences(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpSentences(-1) + loopBegin > jumpSentences(-1) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpSentences(-1) + loopBegin > jumpSentences(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpSentences(-1) + newWordFragment > jumpSentences(-1) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	
	// 'doubles: jumpSentences(0) + onceBegin > jumpSentences(0) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpSentences(0) + onceBegin > jumpSentences(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpSentences(0) + loopBegin > jumpSentences(0) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["Victorious,"]
	// 'doubles: jumpSentences(0) + loopBegin > jumpSentences(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]
	// 'doubles: jumpSentences(0) + newWordFragment > jumpSentences(0) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [0.08333333333333333]

	// 'doubles: jumpSentences(100) + onceBegin > jumpSentences(100) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpSentences(100) + onceBegin > jumpSentences(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpSentences(100) + loopBegin > jumpSentences(100) + newWordFragment' =  // Expected test to fail, but it DIDN'T FAIL. expected and got ["wattlebird?"]
	// 'doubles: jumpSentences(100) + loopBegin > jumpSentences(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	// 'doubles: jumpSentences(100) + newWordFragment > jumpSentences(100) + progress' =  // Expected test to fail, but it DIDN'T FAIL. expected and got [1]
	...
	// --- playBegin, playFinish, 42224 tests ---
	'doubles: play(null) + playBegin > reset(null) + newWordFragment': false,  // frags expected ["Victorious,"], but got ["Victorious,","Victorious,"]
	'doubles: play(null) + playBegin > reset(null) + progress': false,  // 'progress' expected [0.08333333333333333], but got [0.08333333333333333,0.08333333333333333]
	'doubles: play(null) + playBegin > restart(null) + newWordFragment': false,  // frags expected ["Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"], but got ["Victorious,","Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"]
	'doubles: play(null) + playBegin > restart(null) + progress': false,  // 'progress' expected [0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1], but got [0.08333333333333333,0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1]
	// The queue is working, but the tests listen before the function actually gets
	// called. Maybe there's a way to alter the tests so that they don't
	// set up the listeners until after the function has actually been called
	...
	'doubles: play(null) + playBegin > fastForward(null) + newWordFragment': false,  // frags expected ["you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"], but got ["Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"]
	'doubles: play(null) + playBegin > fastForward(null) + progress': false,  // 'progress' expected [0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1], but got [0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1]
	...
	'doubles: togglePlayPause(null) + playBegin > reset(null) + newWordFragment': false,  // frags expected ["Victorious,"], but got ["Victorious,","Victorious,"]
	'doubles: togglePlayPause(null) + playBegin > reset(null) + playFinish': false,  // event should not have been triggered but WAS
	'doubles: togglePlayPause(null) + playBegin > reset(null) + progress': false,  // 'progress' expected [0.08333333333333333], but got [0.08333333333333333,0.08333333333333333]
	'doubles: togglePlayPause(null) + playBegin > restart(null) + newWordFragment': false,  // frags expected ["Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"], but got ["Victorious,","Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"]
	'doubles: togglePlayPause(null) + playBegin > restart(null) + playFinish': false,  // event should not have been triggered but WAS
	'doubles: togglePlayPause(null) + playBegin > restart(null) + progress': false,  // 'progress' expected [0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1], but got [0.08333333333333333,0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1]
	...
	'doubles: togglePlayPause(null) + playBegin > fastForward(null) + newWordFragment': false,  // frags expected ["you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"], but got ["Victorious,","you","brave","flag.","Delirious,","I","come","back.","\n","Why,","oh","wattlebird?"]
	'doubles: togglePlayPause(null) + playBegin > fastForward(null) + playFinish': false,  // event should not have been triggered but WAS
	'doubles: togglePlayPause(null) + playBegin > fastForward(null) + progress': false,  // 'progress' expected [0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1], but got [0.08333333333333333,0.16666666666666666,0.25,0.3333333333333333,0.4166666666666667,0.5,0.5833333333333334,0.6666666666666666,0.75,0.8333333333333334,0.9166666666666666,1]
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(-1) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(0) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(3) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(4) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(11) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpWords(100) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpSentences(-1) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpSentences(0) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpSentences(3) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpSentences(100) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > nextWord(null) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > nextSentence(null) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > prevWord(null) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > prevSentence(null) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpTo(-1) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpTo(0) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpTo(6) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpTo(11) + playFinish': false,  // event should not have been triggerd but WAS
	...
	'doubles: togglePlayPause(null) + playBegin > jumpTo(100) + playFinish': false,  // event should not have been triggerd but WAS
